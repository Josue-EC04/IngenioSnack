...
| **9. VENTAJA INJUSTA** | El sistema ya existe — agregar suscripción es incremental, no una construcción desde cero. La relación de confianza del Sr. Julio con los estudiantes de la FIS es insustituible. Los datos históricos de pedidos de la Iteración 1 ya permiten predecir qué combinará mejor. |
...
### 3️ Propuesta de Valor Única (UVP)
...
│              │  diaria      │  listo antes │  existe,     │  FIS-UNCP    │
...
│  • Tasa de confirmación     │              │  • Fidelidad: 5 días = 1    │
